  ...
  <div class="containerpage">
    ...
    <div class="video_box" v-show="play_way">
        <video class="video_play" id="video_play" :poster="video_poster" show-center-play-btn="false" autoplay="true" bindpause="bindpause" :src="video_src"
                       controls="true" :initial-time="playstartTime" bindended="playend" bindtimeupdate="playtime" bindplay="videoplay" v-show="playvideo"></video>
    ...
    <div class="speak_div speak_div_f" v-show="speak_div_top">
        ...
        <div class="speak_right">
            ...
            <div id="collect" class="fr collect speak_right_icon iscollect" v-show="playDetails_co" :data-id="playDetails.video_info.id"></div>
            <div id="collect" class="fr collect speak_right_icon" v-show="!playDetails_co" :data-id="playDetails.video_info.id" @click = "collects"></div>
        </div>
    </div>
    ...
    <scroll-view scroll-y  class="scrv" bindscroll="scrollWhere">
            ...
            <div class="video_detail ">
                ...
                <div class="video_bottom">
                    <div id="video_in_h">
                        ...
                        <div class="content_intr txt_con" id="giveheight" v-if="playDetails.video_info.content">
                ...
                <!--选集信息-->
                <div class="video_fff">
                    <div class="choose_title" v-if="mins">
                    ...
                    <scroll-view class="choose_video choose_video_s" scroll-x="true">
                        <div v-for="item in choosevideo">
                            ...
                            <div class="op">
                                <a open-type="redirect" class="scroll_div_a" :href="'../videoDetail/videoDetail?id='+item.id+'&uid='+item.id+'&userid='+item.user_id+'&shop_id='+shop_id+'&share_uid='+share_uid">
                ...
                <div class="teacher_card">
                     <div class="userinfo">
                            <div class="headpic_new">
                                <a :href="'../../detail/teacher/teacher?uid='+playDetails.user.uid+'&shop_id='+shop_id+'&share_uid='+share_uid">
                        ...
                        <div class="followicon" id="focus"  @click = "follows">
                            ...
                            <img wx:else src="../../../static/images/teacher_follow.png">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="over_bg" v-if="overshow">
            <div class="over_tips"  v-if="overshow">
                <img src="../../../static/images/guanbi1.png" mode="aspectFill" @click="close_overtip" class="close_tan">
            ...
            <div v-if="no_talk"><!--评论框是否打开-->
                <div v-if="try_video && environment"><!--试看或免费-->
                    <div class="new_bottom"  v-if="playDetails.video_info.payment>0 && playDetails.user.is_allow ==0 ">
                        <div class="new_bottom_left fl">
                            <div class="yellow_txt">￥{{playDetails.video_info.payment}}</div>
                        </div>
                        <a class="new_bottom_btn fr" :href="'../confirm/confirm?id='+playDetails.video_info.id+'&priceVideo='+playDetails.video_info.payment+'&nameVideo='+playDetails.video_info.name+'&bgImg='+bgImg+'&shop_id='+shop_id+'&share_uid='+share_uid">购买本集视频</a>
                    </div>
                </div>
            </div>
